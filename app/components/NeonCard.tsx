    ...
    <article className="group relative isolate flex h-full flex-col rounded-sm bg-bg-elev p-6 neon-border hover:neon-border-hover [@media(hover:none)]:neon-border-hover">
      ...
      <div className="mt-auto pt-6 flex items-end justify-between gap-4">
        <a
          ...
          className="relative z-10 shrink-0 flex items-center gap-2 text-fg-muted transition-colors duration-200 hover:text-cyan hover:animate-neon-flicker focus-visible:text-cyan focus-visible:animate-neon-flicker [@media(hover:none)]:text-cyan [@media(hover:none)]:rounded-sm [@media(hover:none)]:border [@media(hover:none)]:border-cyan/40 [@media(hover:none)]:px-3 [@media(hover:none)]:py-1.5 [@media(hover:none)]:shadow-[0_0_10px_rgba(0,240,255,0.25),inset_0_0_6px_rgba(0,240,255,0.15)]"
        >
